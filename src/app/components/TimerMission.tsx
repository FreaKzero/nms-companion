...
export const TimerMission: React.FC<TimerComponentProps> = ({ storageKey }) => {
  ...
  return (
    <Card title={timerData ? timerData.label : watchedLabel || 'Timer'}>
      <div style={{ backgroundImage: `url(${timerback})` }} className='h-full bg-cover p-5'>
        {!timerData
          ? (
          ...
          : isExpired
            ...
            : (
              <div className='flex flex-col items-center gap-2'>
                <div className='font-nms mt-5 mb-3 text-shadow-lg text-4xl bg-gradient-to-b from-white to-gray-400 bg-clip-text text-transparent'>
                  {remaining !== null
